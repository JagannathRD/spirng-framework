...
<body>
	...
	<div class="text-success" style="text-align: center">${success}</div>
	<div style="background-color:;">

		<div class="container">
			<form action="landing.do" name="Form" method="post"
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<input title="First Name" type="text" class="form-control mt-3"
							placeholder="First Name" name="fName"> <span id="n"
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control mt-3" placeholder="Email"
							name="email"> <span id="e" class="text-danger"></span>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<input type="password" class="form-control mt-3"
							placeholder="Password" name="password"> <span id="p"
							class="text-danger"></span>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<input type="password" class="form-control mt-3"
							placeholder="Confirm Password" name="cPassword"> <span
							id="cp" class="text-danger"></span>
					</div>
				</div>

				<input type="submit" class="btn btn-primary" value="Register" /><span></span>
