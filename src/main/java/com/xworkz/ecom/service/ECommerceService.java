...
public interface ECommerceService {
	...
	List<ECommerceDTO> loginDetails(String email) throws ServiceException;

	void updateNameByEmail(String email, String fName, String lName) throws ServiceException;
}
