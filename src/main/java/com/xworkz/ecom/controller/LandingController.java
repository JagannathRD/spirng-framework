...
public class LandingController {
	...
	public String doLogin(@ModelAttribute ECommerceDTO dto,@ModelAttribute LoginDTO loginDTO,Model m) throws ControllerException{
		try {
						
			List<ECommerceDTO> list=service.validateAndLogin(dto);
			...
			for (ECommerceDTO object : list) {
				...
				if(object.getPassword().equals(loginDTO.getPassword())){
					...
					m.addAttribute("name","Hi "+object.getfName());
				}
				else{
					System.out.println(object);
